...
(doc) ->
  ...
  if doc._id[0..9] is "enrollment"
    if doc.attendance
      firstStudent = null
      for data, student of doc.attendance
        firstStudent = student
        break
      dates =  Object.keys(firstStudent).sort()
      lastDate = dates[dates.length-1]
      # val will be the last date recorded for the attendance (should be same for all students)
      emit [doc._id[23..26], doc._id[33], regionBySchoolId[doc._id[18..21]]], lastDate
