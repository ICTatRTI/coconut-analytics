  ...
  render: =>
    @$el.html "
      ...
      <dialog id='aboutDialog'>
        ...
        <div id='license'>
          <p><i class='mdi mdi-copyright mdi-24px'></i> Copyright 2017 RTI International. </p>
        ...
        <div>Coconut KEEP has been developed by RTI in close collaboration with the Kenya Equity in Education Project (KEEP) and
        the World University Service of Canada (WUSC) and funded by WUSC.</div>
